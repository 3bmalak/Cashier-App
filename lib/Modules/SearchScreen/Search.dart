              ...
              Row(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if(controller.text==""){
                        AppCubit.get(context).addToCart(model, 1);
                        model.quantity-=1;
                      }
                      else {
                        AppCubit.get(context).addToCart(model, int.parse(controller.text));
                        model.quantity-=int.parse(controller.text);
                      }
                      controller.text="";
                      Navigator.of(context).pop();
                    },
