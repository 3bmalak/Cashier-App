              ...
              DefaultButton(
                ...
                function: ()
                {
                  if( AppCubit.get(context).cart2.length==0){
                    ...
                    showCustomDialog(
                        height, width, context, payController, phone.text);
                  }
...
void showCustomDialog(height,width,context ,TextEditingController controller,phone) =>
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      AppCubit.get(context).found? ' ${AppCubit.get(context).payingCost.toStringAsFixed(1)} LE':' ${AppCubit.get(context).totalCost.toStringAsFixed(1)} LE',
                      textAlign: TextAlign.center,
                ...
                Row(
                  children: [
                    ...
                    Checkbox(
                      value:AppCubit.get(context).isChecked,
                      onChanged: (bool? value) {


                        AppCubit.get(context).s(value!);
                        if(AppCubit.get(context).isChecked==true&&AppCubit.get(context).client!.offer!="0"){
                          AppCubit.get(context).found=true;
                          double s =double.parse(AppCubit.get(context).client!.offer);
                          double sp =1-(s/100);
                          AppCubit.get(context).payingCost=0;
                          AppCubit.get(context).payingCost+=(double.parse(AppCubit.get(context).totalCost.toStringAsFixed(1))*sp);
                          print(  AppCubit.get(context).totalCost);
                          print(sp);
                        ...
                        else if(AppCubit.get(context).isChecked==false&&AppCubit.get(context).client!.offer!="0"){
                          AppCubit.get(context).found=false;
                         //  double s =double.parse(AppCubit.get(context).client!.offer);
                         // double sp =1+(s/100);
                         // print(sp);
                         //
                         //  AppCubit.get(context).totalCost=double.parse(AppCubit.get(context).totalCost.toStringAsFixed(1))*sp;
                         //  print(  AppCubit.get(context).totalCost);
                          AppCubit.get(context).changeState();
                        }
                        else{
                          showToast("this user have no Discount");
                        }
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      AppCubit.get(context).isChecked? ' ${AppCubit.get(context).client?.offer} %':' 0 %',
                      textAlign: TextAlign.center,
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if(AppCubit.get(context).found==true){
                          d=AppCubit.get(context).payingCost;
                        }
                        if(AppCubit.get(context).found==false){
                          d=AppCubit.get(context).totalCost;
                        }
                        ...
                        AppCubit.get(context).saveHistory(paid,context,cartid);
